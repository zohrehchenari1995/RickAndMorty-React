...
function CharacterDetail({ selectedId, onAddFavorite, isAddToFavorite }) {
  ...
  if (!character || !selectedId)
    return <div style={{ flex: 1 }}>please selecte a chracter</div>;
        ...
        <div className="character__location">
          ...
          {isAddToFavorite ? (
            ...
            <button
              ...
              className="location__button-add"
            >
              Add To Favorite
            </button>
          )}
...
function EpisodeList({ episodes }) {
  // state for sort button in episodes
  ...
  return (
    <div className="all__episode">
      <button className="episode__title" onClick={() => setSortBy((is) => !is)}>
